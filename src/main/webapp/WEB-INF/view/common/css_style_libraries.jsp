...
<link rel="icon" sizes="192x192" href="/resources/lib/images/android-desktop.png">

<!-- Add to homescreen for Safari on iOS -->
<meta name="apple-mobile-web-app-capable" content="yes">
<meta name="apple-mobile-web-app-status-bar-style" content="black">
<meta name="apple-mobile-web-app-title" content="Material Design Lite">
<link rel="apple-touch-icon-precomposed" href="/resources/lib/images/ios-desktop.png">
...
<meta name="msapplication-TileImage" content="/resources/lib/images/touch/ms-touch-icon-144x144-precomposed.png">
